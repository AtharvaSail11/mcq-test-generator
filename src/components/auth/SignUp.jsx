...
const SignUp=()=>{
    ...
    return(
        <div className="flex justify-center items-center h-full w-full bg-gradient-to-tl bg-white">
           <div className="flex flex-col items-center w-[350px] h-[500px] md:w-[400px] shadow-lg border border-slate-200 rounded-lg">
            <div className="flex justify-center items-center h-[20%] w-full mb-5">
                <p className="text-[40px] font-medium text-black">Sign In</p>
            </div>
            <form className="flex flex-col gap-2 h-[80%] w-[90%] items-center" onSubmit={handleSubmit}>
                ...
                <input 
                    ...
                    required
                />
                <button className="w-[75%] h-max shadow-lg font-medium text-sm cursor-pointer text-white px-8 py-3 bg-blue-800 rounded-xl">Submit</button>
            </form>
           </div>
        </div>
    )
