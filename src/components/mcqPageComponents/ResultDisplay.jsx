    ...
    return (
        <div className="flex flex-col items-center w-full p-5">
            ...
            <div className="flex flex-col items-center w-1/2 h-max">
                <p className="font-semibold text-base lg:text-2xl text-green-500">Correct:{correctAnswer}</p>
                <p className="font-semibold text-base lg:text-2xl text-red-500">Incorrect:{incorrectAnswer}</p>
            </div>
