    ...
    return (
        <div className="flex flex-col gap-10 absolute bg-white shadow-lg max-w-2xl rounded-xl justify-center w-full p-5">
            ...
            {testGenerationType === 'AI' ? (
                ...
                <div className="flex flex-col gap-10 w-full justify-center">
                    <div className="flex flex-col w-full h-[200px] border-2 border-gray-400 rounded overflow-auto">
                        <p className="font-bold">Instructions</p>
                        <p>{"1.Open gemini or any AI chatbot"}</p>
                        <p>{"2.Upload your files in the chat"}</p>
                        <p>{"3.Paste this Prompt:"}</p>
                        <div className="p-2">
